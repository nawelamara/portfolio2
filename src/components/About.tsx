...
export default function About() {
  ...
  return (
    <section id="about" className="min-h-screen flex items-center justify-center py-20 relative" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className={`text-gray-300 text-lg leading-relaxed transition-all duration-1000 ${isVisible ? 'scroll-fade-in-left' : 'opacity-0'}`} style={{ animationDelay: '0.1s' }}>
            ...
            <p className={`text-gray-300 text-lg leading-relaxed transition-all duration-1000 ${isVisible ? 'scroll-fade-in-left' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
            ...
            <p className={`text-gray-300 text-lg leading-relaxed transition-all duration-1000 ${isVisible ? 'scroll-fade-in-left' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
          ...
          <div className="space-y-6">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`group p-6 rounded-xl bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300 hover:scale-105 card-glow ${isVisible ? 'scroll-scale-in' : 'opacity-0'}`}
